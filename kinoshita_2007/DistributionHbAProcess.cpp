...
LIBECS_DM_CLASS( DistributionHbAProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( DistributionHbAProcess, Process ){
  ...
  virtual void initialize(){
    ...
    DPG1 = getVariableReference( "DPG1" );
    DPG2 = getVariableReference( "DPG2" );
    DPG3 = getVariableReference( "DPG3" );
    DPG4 = getVariableReference( "DPG4" );
    DPG5 = getVariableReference( "DPG5" );
    DPG6 = getVariableReference( "DPG6" );
  ...
  virtual void fire(){
    ...
    Real BPG1 = DPG1.getVariable()->getMolarConc();//f23DPG
    Real BPG2 = DPG2.getVariable()->getMolarConc();//Mg23DPG
    Real BPG3 = DPG3.getVariable()->getMolarConc();//oxyHb23DPG
    Real BPG4 = DPG4.getVariable()->getMolarConc();//deoxyHb23DPG
    Real BPG5 = DPG5.getVariable()->getMolarConc();//band3oxyHb23DPG
    Real BPG6 = DPG6.getVariable()->getMolarConc();//band3deoxyHb23DPG

    //    Real BPG = E4.getVariable()->getMolarConc();
    Real BPG = BPG1 + BPG2 + BPG3 + BPG4 + BPG5 + BPG6;
 ...
 protected:
  ...
  VariableReference DPG1;
  VariableReference DPG2; 
  VariableReference DPG3;                                                  
  VariableReference DPG4;
  VariableReference DPG5;
  VariableReference DPG6;                     
...
LIBECS_DM_INIT( DistributionHbAProcess, Process );
