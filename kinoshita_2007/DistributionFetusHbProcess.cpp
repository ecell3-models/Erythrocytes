...
LIBECS_DM_CLASS( DistributionFetusHbProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( DistributionFetusHbProcess, Process ){
...
LIBECS_DM_INIT( DistributionFetusHbProcess, Process );
