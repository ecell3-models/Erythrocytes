...
LIBECS_DM_CLASS( Circulation5Process, Process )
{

 public:
  
  LIBECS_DM_OBJECT( Circulation5Process, Process ){
  ...
  virtual void fire(){
	...
	PO2 = 98 - 25 * (theCalcTime - 2.54)/(0.5 + (theCalcTime - 2.54));
...
LIBECS_DM_INIT( Circulation5Process, Process );
