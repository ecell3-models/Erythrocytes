...
LIBECS_DM_CLASS( DistributionHbProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( DistributionHbProcess, Process ){
...
LIBECS_DM_INIT( DistributionHbProcess, Process );
