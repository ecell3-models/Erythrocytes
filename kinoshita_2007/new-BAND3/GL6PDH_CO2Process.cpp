...
LIBECS_DM_CLASS( GL6PDH_CO2Process, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( GL6PDH_CO2Process, Process ){
  ...
  virtual void fire(){
    ...
    if( ActCo == 0 ){ 
      ...
      Real P =  (0.0012/40.0)*P0.getVariable()->getValue();//PCO2->[CO2]
...
LIBECS_DM_INIT( GL6PDH_CO2Process, Process );
