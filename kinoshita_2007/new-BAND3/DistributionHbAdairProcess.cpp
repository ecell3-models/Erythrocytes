...
LIBECS_DM_CLASS( DistributionHbAdairProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( DistributionHbAdairProcess, Process ){
...
LIBECS_DM_INIT( DistributionHbAdairProcess, Process );
