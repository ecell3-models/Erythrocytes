...
LIBECS_DM_CLASS( Circulation6Process, Process )
{

 public:
  
  LIBECS_DM_OBJECT( Circulation6Process, Process ){
  ...
  virtual void fire(){
	...
	PO2 = 60 - 16 * (theCalcTime - 2.57)/(0.5 + (theCalcTime - 2.57));
...
LIBECS_DM_INIT( Circulation6Process, Process );
