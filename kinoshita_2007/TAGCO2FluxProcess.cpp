...
LIBECS_DM_CLASS( TAGCO2FluxProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( TAGCO2FluxProcess, Process ){
...
LIBECS_DM_INIT( TAGCO2FluxProcess, Process);
