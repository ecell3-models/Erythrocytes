...
LIBECS_DM_CLASS( DistributionTESTProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( DistributionTESTProcess, Process ){
...
LIBECS_DM_INIT( DistributionTESTProcess, Process );
