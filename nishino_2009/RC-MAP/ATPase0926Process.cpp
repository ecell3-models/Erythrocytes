...
LIBECS_DM_CLASS( ATPase0926Process, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( ATPase0926Process, Process ){
  ...
  virtual void fire(){
    ...
    Real ActCo = E0.getVariable()->getValue() * 2;
...
LIBECS_DM_INIT( ATPase0926Process, Process );
