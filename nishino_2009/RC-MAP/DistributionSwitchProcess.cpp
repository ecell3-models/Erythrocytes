...
LIBECS_DM_CLASS( DistributionSwitchProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( DistributionSwitchProcess, Process ){
    ...
    PROPERTYSLOT_SET_GET( Real,flag  );
    //    PROPERTYSLOT_GET( Real,Ka  );

  }
  
  DistributionSwitchProcess()
    :
    n(0.0),
    Wrbc(0.0),
    Wpl(0.0),
  ...
  SIMPLE_SET_GET_METHOD( Real,flag  );
...
LIBECS_DM_INIT( DistributionSwitchProcess, Process );
