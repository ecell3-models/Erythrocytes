...
LIBECS_DM_CLASS( GLCSupplyProcess, ContinuousProcess )
{

 public:

  LIBECS_DM_OBJECT( GLCSupplyProcess, Process )
    {
  ...
  virtual void fire()
  {
    ...
    velocity = velocity * E5.getValue() / 1000;
    
    velocity = velocity * SW;
...
LIBECS_DM_INIT( GLCSupplyProcess, Process );
