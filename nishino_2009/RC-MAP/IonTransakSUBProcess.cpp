...
LIBECS_DM_CLASS( IonTransakSUBProcess, ContinuousProcess )
{
  
 public:
  
  LIBECS_DM_OBJECT( IonTransakSUBProcess, Process ){
...
LIBECS_DM_INIT( IonTransakSUBProcess, Process );
